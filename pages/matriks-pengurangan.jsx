...
export default function MatriksPengurangan() {
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="">
                    <input 
                    ref={matA11}
                    className="appearance-none block w-32 md:w-50 lg:w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" />
                  </div>
                  <div className="">
                    <input
                      ref={matA12}
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="">
                    <input 
                    ref={matA11}
                    className="appearance-none block w-20 md:w-50 lg:w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" />
                  </div>
                  <div className="">
                    <input
                      ref={matA12}
